...
In model 3 and 4, the AR(1) statistic turns out to be insignificant at the 5% level, that is we fail to reject the null hypothesis that there is no autocorrelation of order 1. This means that in these models, the application of OLS should give reasonable estimates. This is what is done next.
